...
<%@ page import="com.mlvn.crud_users.model.*"%>
...
<body>
	...
	<br>
	<br>
	<html:form action="/process-edit-user.html" method="post">
		<%UserDB user = (UserDB) request.getAttribute("user"); %>
		<html:hidden name="prod" property="id" value="<%=String.valueOf(user.getId())%>"></html:hidden>
		<br>
		<label>Name</label>
		...
		<html:text property="birthday" name="prod" value="<%=String.valueOf(user.getBirthday())%>"></html:text>
		<br>
